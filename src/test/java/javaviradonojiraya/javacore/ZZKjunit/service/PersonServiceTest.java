package javaviradonojiraya.javacore.ZZKjunit.service;
...
class PersonServiceTest {
    ...
    void isAdult_ReturnFalse_WhenAgeIsLowerThan18() {
        Assertions.assertFalse(personService.isAdult(notAdult)); //assim
    }
    ...
    @Test
    @DisplayName("Should return list whit only adults")
