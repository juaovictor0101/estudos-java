...
public class ProducerRepository {
    ...
    public static void update(Producer producer) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPeparedStatementUpdate(conn, producer)) {
            ps.execute();
        } catch (SQLException e) {
    ...
    private static PreparedStatement createPeparedStatementUpdate(Connection conn, Producer producer) throws SQLException {
