...
public class TemporalAdjustersTest01 {
    public static void main(String[] args) {
        ...
        //é util para manipular a data inteira, dia/mês/ano
        LocalDate now = LocalDate.now();
        now = now.withMonth(3); //metodo With+ day/month ou year muda só o que selecionar no metodo e mantem os restantes dos números da data iguais
